      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className={`flex items-center justify-between transition-all duration-300 ${
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            >
              Início
              <span className={`absolute bottom-0 left-1/2 h-0.5 bg-[#3bb664] transition-all duration-300 ease-in-out transform -translate-x-1/2 w-0 opacity-0 group-hover:w-full group-hover:opacity-100`}></span>
            </a>
            <a 
              href="/#sobre"
            ...
            >
              Sobre
              <span className="absolute bottom-0 left-1/2 w-0 h-0.5 bg-[#3bb664] transition-all duration-300 ease-in-out opacity-0 transform -translate-x-1/2 group-hover:w-full group-hover:opacity-100"></span>
            </a>
            <a 
              href="/#servicos"
